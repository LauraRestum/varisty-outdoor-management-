...
export const metadata: Metadata = {
  title: 'Hardscaping Services | Patios, Walkways & Retaining Walls',
  description: 'Paver patios, flagstone walkways, retaining walls, and outdoor living spaces built to last. Professional hardscaping in Central Ohio.',
}

const FEATURES = [
  'Paver and natural stone patio installation',
  'Concrete and flagstone walkways',
  'Retaining walls for slopes and erosion control',
  'Fire pit construction and surround areas',
  'Steps and stair installations',
  'Edging, gravel, and border work',
      ...
      <section className="py-20 md:py-28 bg-dark-card border-b border-dark-border">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-brand-green text-sm font-semibold">Hardscaping</span>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="font-condensed text-5xl md:text-6xl font-black uppercase text-white mb-4">
                OUTDOOR SPACES <span className="text-brand-green">BUILT TO LAST</span>
              </h1>
              <p className="text-gray-400 text-xl leading-relaxed mb-8">
                From a simple walkway to a complete outdoor room with patio, fire pit, and retaining walls — Varsity builds hardscape features that add lasting value to your home.
              </p>
            ...
            <div className="bg-dark-bg rounded-2xl border border-dark-border p-6">
              <h3 className="font-condensed text-lg font-bold uppercase text-brand-green mb-4">What We Build</h3>
      ...
      <section className="py-16 bg-dark-card border-t border-dark-border">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="font-condensed text-4xl font-black uppercase text-white mb-4">
            Build Your <span className="text-brand-green">Dream Outdoor Space</span>
          </h2>
          <p className="text-gray-400 mb-8">Get a free design consultation and estimate for your hardscaping project.</p>
